...
void GVRET_Comm_Handler::processIncomingByte(uint8_t in_byte)
{
    ...
    case IDLE:
        ...
        {
            DEBUG(" console.rcvCharacter\n");
            console.rcvCharacter((uint8_t)in_byte);
        }
        break;
    case GET_COMMAND:
        DEBUG("Case GET_COMMAND\n");
        switch (in_byte)
        {
        case PROTO_BUILD_CAN_FRAME:
            DEBUG("Case PROTO_BUILD_CAN_FRAME\n");
            DEBUG(" change state to BUILD_CAN_FRAME\n");
            state = BUILD_CAN_FRAME;
            buff[0] = 0xF1;
            step = 0;
            break;
        case PROTO_TIME_SYNC:
            DEBUG("Case PROTO_TIME_SYNC\n");
        ...
        case PROTO_SET_DIG_OUT:
            DEBUG("Case PROTO_SET_DIG_OUT\n");
            DEBUG(" change state to SET_DIG_OUTPUTS\n");
            state = SET_DIG_OUTPUTS;
            buff[0] = 0xF1;
            break;
        case PROTO_SETUP_CANBUS:
            DEBUG("Case PROTO_SETUP_CANBUS\n");
            DEBUG(" change state to SETUP_CANBUS\n");
            state = SETUP_CANBUS;
            step = 0;
            buff[0] = 0xF1;
            break;
        ...
        case PROTO_SET_SYSTYPE:
            DEBUG("Case PROTO_SET_SYSTYPE\n");
            buff[0] = 0xF1;
            DEBUG(" change state to SET_SYSTYPE\n");
            state = SET_SYSTYPE;
            step = 0;
            break;
        case PROTO_ECHO_CAN_FRAME:
            DEBUG("Case PROTO_ECHO_CAN_FRAME\n");
            DEBUG(" change state to ECHO_CAN_FRAME\n");
        ...
        case PROTO_SET_EXT_BUSES:
            DEBUG("Case PROTO_SET_EXT_BUSES\n");
            DEBUG(" change state to SETUP_EXT_BUSES\n");
